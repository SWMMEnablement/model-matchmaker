...
export const FIXTURES: Fixture[] = [
  ...
  {
    key: "epanet-sample",
    name: "EPANET — Tiny pressure network (preview)",
    format: "EPANET",
    description: "Preview only — the SWMM5 scoring engine cannot consume EPANET in v1.",
    text: EPANET,
    supported: false,
  },
  {
    key: "icm-sample",
    name: "ICM — InfoWorks export (preview)",
    format: "ICM",
    description: "Preview only — an ICM adapter is on the roadmap; not scored in v1.",
    text: ICM,
    supported: false,
  },
];
